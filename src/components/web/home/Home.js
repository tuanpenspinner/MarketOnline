    ...
    const listCategory = [
      {
        name: "Rau củ",
        img:
          "http://mauweb.monamedia.net/vuonrau/wp-content/uploads/2019/05/p9-100x100-1.jpg",
      },
      {
        name: "Trái cây",
        img:
          "http://mauweb.monamedia.net/vuonrau/wp-content/uploads/2019/05/p1-100x100.jpg",
      },
      {
        name: "Thịt",
        img:
          "http://mauweb.monamedia.net/vuonrau/wp-content/uploads/2019/05/4-zalm-loin-white-100x100.png",
      },
      {
        name: "Rau củ",
        img:
          "http://mauweb.monamedia.net/vuonrau/wp-content/uploads/2019/05/p5-100x100-1.jpg",
      },
    ];
    const listBestSell = [
      {
          ...
          <div className="carousel-inner">
            <div className="carousel-item active">
              <img
                ...
                src="https://images6.alphacoders.com/383/thumb-1920-383146.jpg"
                alt="First slide"
              />
            </div>
            <div className="carousel-item">
              <img
                className="d-block w-100"
                src="https://images8.alphacoders.com/837/thumb-1920-837364.jpg"
                alt="Second slide"
              />
            </div>
            <div className="carousel-item">
              <img
                className="d-block w-100"
                src="https://images6.alphacoders.com/919/thumb-1920-919655.jpg"
                alt="Third slide"
              />
            </div>
          </div>
                        ...
                        <div className="card">
                          ...
                          <div className="card-body text-left">
                            ...
                            <div className="content-blog">
                              Ra đời làm ắn bươn trải,có làm ....
                            </div>
                          </div>
                        </div>
                      </Link>
